...
#         self.parser.add_argument("--pseudo_labels_csv", type=str, default="", help="Current file storing pseudo labels")
...
#         self.parser.add_argument("--num_pseudo_labels", type=int, default=8650, help="Number of unlabeled data")
...
parser = ArgumentParser( description="Model parameters for cell classification.")

parser.add_argument("--trial_name", type=str, default="", help="name for training run", required=True)
parser.add_argument("--model_name", type=str, default="efficientnet_b0", help="name of models, which could be:", required=True)
parser.add_argument("--img_size", type=int, default=224, help="Required image size of model")
parser.add_argument("--labeled_anno_file", type=str, default="", help="The path to labeled cells csv file.",required=True)
parser.add_argument("--unlabeled_anno_file", type=str, default="", help="The path to unlabeled cells csv file.",required=True)
parser.add_argument("--output_folder", type=str, default="", help="Folder to store the outputs of the training process",required=True)
parser.add_argument("--image_folder", type=str, default="", help="The path to the folder of images",required=True)
parser.add_argument("--pseudo_labels_csv", type=str, default="", help="Current file storing pseudo labels")
...
parser.add_argument("--num_pseudo_labels", type=int, default=35977, help="Number of unlabeled data")
parser.add_argument("--num_labelled_train_data", type=int, default=35977, help="Number of unlabeled data")
parser.add_argument("--ratio_label_unlabel", type=str, default="1:1:1:3", help="ratio of labeled data to unlabeled data in 3 iterations")
parser.add_argument("--stoch_depth_prob", type=float, default=0.3, help="stochastic_depth_prob of student model")
parser.add_argument("--drop_out_rate", type=float, default=0.9, help="drop_out_rate of student model")
